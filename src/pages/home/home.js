...
import { leftRightContainerList, scaleUpBusiness, whyChooseUs, allBusinessTypes } from "./info"
...
const scaleUpImage = "https://res.cloudinary.com/dbj0t0zym/image/upload/v1689489839/growth_w0phnw.jpg";
...
const Home = () => {
	return (
		<Page title="Homepage || Afrigorithm | Leading Tech Solutions Provider">
			<StyledWrapper>
				<Banner/>
